#
#  Be sure to run `pod spec lint CollectiveSwift.podspec' to ensure this is a
...
of UIKit objects, e.g., outlet collections.
  ...
  # spec.author             = { "Greg Pape" => "github@gpape.com" }
  spec.author    = "Greg Pape"
  # spec.authors            = { "Greg Pape" => "github@gpape.com" }
  # spec.social_media_url   = "https://twitter.com/Greg Pape"
